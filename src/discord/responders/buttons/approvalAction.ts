...
import { EmbedBuilder, GuildMember, PermissionsBitField, ColorResolvable } from "discord.js";
    ...
    async run(interaction, { action, userId }) {
        ...
        try {
            ...
            if (!targetMember) {
                ...
                updatedEmbed.setColor(constants.colors.danger as ColorResolvable);
            ...
            if (action === "accept") {
                ...
                originalEmbed
                    .setColor(constants.colors.success as ColorResolvable)
                ...
                originalEmbed
                    .setColor(constants.colors.danger as ColorResolvable)
                    .setDescription(currentDescription);
