...
import { ButtonBuilder, ButtonStyle, ChannelType, ColorResolvable, EmbedBuilder, GuildMember, TextChannel } from "discord.js";
...
Criado: ${createdAt}`;
            ...
            const requestEmbed = new EmbedBuilder()
                .setColor(constants.colors.default as ColorResolvable)
                .setTitle(title)
